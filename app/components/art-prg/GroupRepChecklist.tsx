  ...
  return (
    <Collapsible.Root open={open} onOpenChange={setOpen}>
      <Collapsible.Trigger asChild>
        <button
          className=" group relative mb-4 w-full overflow-hidden rounded-xl border border-[#8d6d2c] bg-linear-to-b from-[#1d232b] via-[#171c22] to-[#101419] text-left transition-all duration-300 hover:border-amber-400 hover:shadow-[0_0_18px_rgba(255,190,70,.15)] " >
      ...
      <Collapsible.Content className="space-y-3">
        {visibleGroups.map((group, index) => (
          <div
            key={group.groupId}
            className="rounded-xl border border-[#8d6d2c] bg-linear-to-b from-[#1b2027] via-[#171c22] to-[#111418] p-4 shadow-md opacity-0 animate-[fadeIn_.35s_ease_forwards] transition-all duration-300 hover:border-amber-400 hover:shadow-[0_0_18px_rgba(255,190,70,.15)]"
